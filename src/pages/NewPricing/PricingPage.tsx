  ...
  return (
    <main>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-12 text-center">
        ...
        <h1 className="font-display text-5xl md:text-7xl leading-[1.05] tracking-tight mb-8 max-w-4xl mx-auto">
          One price. Everything included. <em className="italic text-rust">No contract.</em>
        </h1>
      ...
      <section className="max-w-3xl mx-auto px-6 lg:px-12 py-12">
        <div className="bg-paper border-2 border-ink rounded-3xl p-12 relative overflow-hidden">
          ...
          <p className="text-warmgrey mb-8">No tiers. No upsells. No setup fee.</p>
          <div className="flex items-baseline mb-2">
            <span className="font-display text-8xl">$99</span>
            <span className="text-warmgrey text-xl ml-3">/ month</span>
          </div>
          <p className="text-ink/70 mb-10">Cancel any time. No contract.</p>

          <div className="space-y-4 mb-10">
            {features.map(([feature, note], i) => (
              <div key={i} className="flex gap-3 items-start">
                <span className="text-rust mt-1">&check;</span>
                <span>
                  {feature}
      ...
      <section className="bg-ink text-paper py-32 relative">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <Eyebrow className="mb-6 text-paper/60">The guarantee</Eyebrow>
          ...
          <div className="space-y-6 text-lg text-paper/80 max-w-2xl mx-auto leading-relaxed mb-12">
            <p>That's the deal.</p>
          ...
          <div className="max-w-2xl mx-auto border-t border-b border-paper/20 py-8">
      ...
      <section className="bg-highlight border-y border-rust/20 py-32 relative">
        <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-xl text-ink/70 mb-10">Free. 60 seconds. No card needed. We do all the work. You'll have it within the hour.</p>
          <Link
            to="/free-report"
          ...
          <div className="mt-20 pt-12 border-t border-rust/20 max-w-xl mx-auto">
            ...
            <p className="text-sm text-warmgrey">&mdash; Caleb &middot; <span className="font-mono">(203) 605-1105</span></p>
          </div>
        </div>
      </section>
