...
export const HomePage = () => {
  return (
    <main>
      ...
      {/* ═══ HERO ═══ */}
      <section className="max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-32 grain">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <p className="eyebrow mb-6 fade-up stagger-1">Online marketing, off your plate.</p>
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl leading-[1.05] tracking-tight mb-4 fade-up stagger-2">
              We make your phone <em className="italic text-rust">ring.</em>
            </h1>
            <p className="font-display text-2xl md:text-3xl italic text-warmgrey mb-8 fade-up stagger-2">
              Then we stay out of your hair.
            </p>
            <p className="text-lg md:text-xl text-ink/75 max-w-xl leading-relaxed mb-10 fade-up stagger-3">
              We do your website. We run your Google page. We reply to every review. You just answer the phone when it starts ringing.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center fade-up stagger-4">
              <Link to="/free-report" className="btn-primary px-8 py-4 rounded-full text-base font-medium">
                Run My Free Report
              </Link>
              <p className="text-sm text-warmgrey">No card. No call. Just the report.</p>
            </div>
          </div>

          {/* Hero phone mockup */}
          <div className="lg:col-span-5 flex justify-center fade-up stagger-3">
            <div className="phone-shadow">
              <svg viewBox="0 0 320 640" className="w-72 md:w-80">
                ...
                <rect x="10" y="58" width="300" height="58" fill="#FAF8F4"/>
                <line x1="10" y1="116" x2="310" y2="116" stroke="#E8E4DC"/>
                <text x="25" y="92" fontFamily="Geist" fontSize="22" fill="#E2552C" fontWeight="300">{'\u2039'}</text>
                <circle cx="160" cy="78" r="15" fill="#E2552C"/>
                <text x="160" y="84" textAnchor="middle" fontFamily="Instrument Serif" fontSize="16" fontStyle="italic" fill="#FAF8F4">w</text>
                <text x="160" y="108" textAnchor="middle" fontFamily="Geist" fontSize="11" fontWeight="600" fill="#0F0F0E">Caleb · WorkBuddy</text>
                <text x="160" y="138" textAnchor="middle" fontFamily="Geist" fontSize="9" fill="#8A857B">Today 10:42 AM</text>
                <rect x="22" y="152" width="220" height="34" rx="16" fill="#E8E4DC"/>
                <text x="35" y="174" fontFamily="Geist" fontSize="12" fill="#0F0F0E">Hey Trey, your new site is live 🎉</text>
                <rect x="22" y="194" width="200" height="34" rx="16" fill="#E8E4DC"/>
                <text x="35" y="216" fontFamily="Geist" fontSize="12" fill="#0F0F0E">panamacitybeachlawn.com</text>
                <rect x="120" y="236" width="180" height="34" rx="16" fill="#0F0F0E"/>
                <text x="290" y="258" textAnchor="end" fontFamily="Geist" fontSize="12" fill="#FAF8F4">wow looks great</text>
                <rect x="22" y="278" width="270" height="68" rx="16" fill="#E8E4DC"/>
                <text x="35" y="298" fontFamily="Geist" fontSize="12" fill="#0F0F0E">also got your Google page to 100%</text>
                <text x="35" y="315" fontFamily="Geist" fontSize="12" fill="#0F0F0E">and replied to your 3 new reviews</text>
                <text x="35" y="332" fontFamily="Geist" fontSize="12" fill="#0F0F0E">this morning</text>
                <rect x="100" y="354" width="200" height="34" rx="16" fill="#0F0F0E"/>
                <text x="290" y="376" textAnchor="end" fontFamily="Geist" fontSize="12" fill="#FAF8F4">man you're a lifesaver</text>
                <rect x="22" y="396" width="278" height="50" rx="16" fill="#FFF1E8" stroke="#E2552C" strokeWidth="1.5"/>
                <text x="35" y="416" fontFamily="Geist" fontSize="12" fill="#0F0F0E">btw 2 new customer calls came in</text>
                <text x="35" y="433" fontFamily="Geist" fontSize="12" fill="#0F0F0E">this morning. check your missed calls</text>
                <text x="160" y="468" textAnchor="middle" fontFamily="Geist" fontSize="9" fill="#8A857B">Delivered · 11:23 AM</text>
                <line x1="10" y1="555" x2="310" y2="555" stroke="#E8E4DC"/>
                <rect x="22" y="568" width="246" height="40" rx="20" fill="#FAF8F4" stroke="#E8E4DC"/>
                <text x="40" y="592" fontFamily="Geist" fontSize="11" fill="#8A857B">iMessage</text>
                <circle cx="288" cy="588" r="14" fill="#0F0F0E"/>
                <text x="288" y="593" textAnchor="middle" fontFamily="Geist" fontSize="14" fill="#FAF8F4">↑</text>
              </svg>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 lg:px-12 py-32">
        <p className="eyebrow mb-6">02 / The shift</p>
        <h2 className="font-display text-5xl md:text-6xl leading-[1.1] mb-12">
        ...
        <div className="mt-16 flex items-center justify-between max-w-2xl">
          <div className="text-center">
            <div className="w-20 h-20 border border-softline rounded-2xl flex items-center justify-center mb-3 bg-paper">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#8A857B" strokeWidth="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>
            </div>
            <p className="font-mono text-xs text-warmgrey">PHONE BOOK</p>
            <p className="font-mono text-xs text-warmgrey">1990s</p>
          </div>
          <div className="flex-1 h-px bg-softline mx-4"></div>
          <div className="text-center">
            <div className="w-20 h-20 border border-softline rounded-2xl flex items-center justify-center mb-3 bg-paper">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#8A857B" strokeWidth="1.5"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
            </div>
            <p className="font-mono text-xs text-warmgrey">GOOGLE</p>
            <p className="font-mono text-xs text-warmgrey">2010s</p>
          </div>
          <div className="flex-1 h-px bg-softline mx-4"></div>
          <div className="text-center">
            <div className="w-20 h-20 border-2 border-rust rounded-2xl flex items-center justify-center mb-3 bg-highlight">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#E2552C" strokeWidth="1.5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
            </div>
            <p className="font-mono text-xs text-rust font-medium">GOOGLE + AI</p>
            <p className="font-mono text-xs text-rust font-medium">NOW</p>
          </div>
        </div>
      ...
      {/* ═══ THE QUIET MATH ═══ */}
      <section className="bg-ink text-paper py-32 grain">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <p className="eyebrow mb-6 text-paper/60">03 / The math</p>
          <h2 className="font-display text-5xl md:text-6xl leading-[1.1] mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            {/* Math card */}
            <div className="bg-paper text-ink rounded-3xl p-10 border border-paper/10">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-32">
        <div className="max-w-3xl mb-20">
          <p className="eyebrow mb-6">04 / What we do</p>
          <h2 className="font-display text-5xl md:text-6xl leading-[1.05] mb-6">
            Three things. <em className="italic text-warmgrey">One outcome: your phone ringing.</em>
          </h2>
          <p className="text-xl text-ink/70 leading-relaxed">There's no dashboard to log into. No course to take. No hour-long onboarding call. We manage all three of these for you, every week. You just answer the calls when they come in.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1: Website */}
          <div className="bg-paper border border-softline rounded-3xl p-8 hover:border-ink transition-colors">
      ...
      {/* ═══ THE GUARANTEE ═══ */}
      <section className="bg-rust text-paper py-32 grain relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 lg:px-12 text-center">
          <p className="eyebrow mb-6 text-paper/70">The promise</p>
          <h2 className="font-display text-6xl md:text-8xl leading-[0.95] mb-10">
            First page of Google <em className="italic">in 30 days.</em>
            <br/>Or you don't pay.
          </h2>
          <p className="text-xl md:text-2xl text-paper/85 leading-relaxed mb-12 max-w-3xl mx-auto">
      ...
      {/* ═══ THE FREE REPORT ═══ */}
      <section className="bg-paper border-y border-softline py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 lg:order-1">
              ...
              <p className="text-xl text-ink/70 leading-relaxed mb-8">This is the thing we're known for. It's free, it takes 60 seconds to start, and you'll have it in your hands in under an hour.</p>
      ...
      {/* ═══ HOW PAYING WORKS ═══ */}
      <section className="max-w-4xl mx-auto px-6 lg:px-12 py-32">
        <p className="eyebrow mb-6">06 / How paying works</p>
        <h2 className="font-display text-5xl md:text-6xl leading-[1.05] mb-12">
      ...
      <section className="bg-ink text-paper py-32 grain">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <p className="eyebrow mb-6 text-paper/60">07 / Who this is for</p>
          <h2 className="font-display text-5xl md:text-6xl leading-[1.05] mb-16">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-32">
        <div className="max-w-3xl mb-20">
          <p className="eyebrow mb-6">08 / Proof</p>
          <h2 className="font-display text-5xl md:text-6xl leading-[1.05] mb-6">
            Real businesses. Real customers. <em className="italic text-rust">Real money in the bank.</em>
          </h2>
          <p className="text-xl text-ink/70 leading-relaxed">We're newer than the agencies that charge five times more, and we're picky about who we work with. Here's what's happened for some of the people who said yes.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-paper border-2 border-rust rounded-3xl p-8 hover:border-ink transition-colors relative">
          ...
          <div className="bg-paper border border-softline rounded-3xl p-8 hover:border-ink transition-colors">
            ...
            <blockquote className="font-display text-6xl leading-none italic mb-6 text-rust">"Deal."</blockquote>
            <div className="bg-highlight border border-rust/30 rounded-xl p-4">
              <p className="text-xs eyebrow mb-1 text-rust">Result</p>
      ...
      {/* ═══ FINAL CTA ═══ */}
      <section className="bg-highlight border-y border-rust/20 py-32 grain">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <p className="eyebrow mb-6 text-rust">09 / Decide</p>
          ...
          <p className="text-xl text-ink/70 leading-relaxed mb-12 max-w-2xl mx-auto">
          ...
          <div className="mt-20 pt-12 border-t border-rust/20 max-w-xl mx-auto">
            ...
            <p className="text-sm text-warmgrey">— Caleb · <span className="font-mono">(203) 605-1105</span></p>
          </div>
        </div>
      </section>
